		...
		<td align="center">
			<c:if test="${count>0 }">
				...
				<c:if test="${startPage > 10 }">
					<a href="/socialfood/food/list.do?pageNum=${startPage-10 }">[이전]</a>
				</c:if>
				<c:forEach var="i" begin="${startPage }" end="${endPage }">
					<a href="/socialfood/food/list.do?pageNum=${i }">${i }</a>
				</c:forEach>
				<c:if test="${endPage < pageCount }">
					<a href="/socialfood/food/list.do?pageNum=${startPage + 10 }">[다음]</a>
				</c:if>
			</c:if>
		</td>
	</tr>
