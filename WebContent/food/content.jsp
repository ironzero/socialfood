		...
		<table width="500" border="1" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td align="center" colspan="4"><input type="button"
					...
					onclick="document.location.href='/socialfood/food/content.do?idx=${article.idx }&pageNum=${pageNum}&rec=1'">

					<input type="button" class="btn-bordcancel"
					value="비추천: ${article.non_recommand}"
					onclick="document.location.href='/socialfood/food/content.do?idx=${article.idx }&pageNum=${pageNum}&non=1'"
					>
			...
			<tr height="30">
				<td colspan="4" bgcolor="${value_c }" align="right"><input
					...
					onclick="document.location.href='/socialfood/food/updateForm.do?idx=${article.idx}&pageNum=${pageNum}'" />
					&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="글삭제"
					onclick="document.location.href='/socialfood/food/deletePro.do?idx=${article.idx }&pageNum=${pageNum}'" />
					&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="답글쓰기"
					onclick="document.location.href='/socialfood/food/writeForm.do?idx=${article.idx }&ref=${article.ref }&step=${article.step }&depth=${article.depth }'" />
					&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="목록"
					onclick="document.location.href='/socialfood/food/list.do?pageNum=${pageNum}'" />
				</td>
			</tr>
		</table>
	</form>
	<form action="/socialfood/food/commentaryWrite.do" method="post">
