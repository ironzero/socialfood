...
<table border="0" align="center" width="1006" height="" style="line-height:100%; margin-top:0; margin-bottom:0;">
   <tr>
   	<td colspan="4">
   		<c:if test="${isLogin == 1 }">
			<p align="right" style="line-height:200%; margin-top:0; margin-bottom:0;"><span style="line-height:200%; margin-top:0; margin-bottom:0; border-width:1; border-style:none;"><a href="javascript:na_open_window('login_win', 'login.jsp', 0, 0, 350, 230, 0, 0, 0, 0, 0)" target="_self" resizable="no"><font size="2" face="굴림" color="#999999">로그아웃</font></a></span><font size="2" face="굴림" color="#999999">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><a href="javascript:na_open_window('join_win', '/socialfood/memberJoinForm.do', 0, 0, 600,500 , 0, 0, 0, 0, 0)" target="_blank"><font size="2" face="굴림" color="#999999">내정보</font></a> &nbsp;&nbsp;</p>
		</c:if>
		<c:if test="${isLogin == 2 }">
			<p align="right" style="line-height:200%; margin-top:0; margin-bottom:0;"><span style="line-height:200%; margin-top:0; margin-bottom:0; border-width:1; border-style:none;"><a href="javascript:na_open_window('login_win', 'login.jsp', 0, 0, 350, 230, 0, 0, 0, 0, 0)" target="_self" resizable="no"><font size="2" face="굴림" color="#999999">로그아웃</font></a></span><font size="2" face="굴림" color="#999999">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><a href="javascript:na_open_window('join_win', 'http://', 0, 0, 300, 200, 0, 0, 0, 0, 0)" target="_blank"><font size="2" face="굴림" color="#999999">관리자페이지</font></a> &nbsp;&nbsp;</p>
		</c:if>
